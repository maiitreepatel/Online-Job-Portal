											...
											<div class="top-company-2">
												<a target="_blank" href="company.php?ref=<?php echo $row['member_no']; ?>">
													...
													<div class="content">
														...
														<p class="texting font600"><?php echo $row['title']; ?>
														<p>
														<p class="mata-p clearfix"><span class="text-primary font700"></span> <span class="font13">Active Job Post(s)</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right"></i></span></p>
													</div>
