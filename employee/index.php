							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										<li class="active">
											<a href="./"><i class="fa fa-user" style="text-transform: uppercase"></i> Profile</a>
										</li>
										<li class="">
										...
										<!--li>
											<a href="referees.php"><i class="fa fa-users"></i> Referee</a>
										</li>-->
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
										...
										<div class="row gap-20">
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-md-4">
													<input value="<?php echo "$myedu"; ?>" placeholder="Eg: Diploma, Degree...etc" name="education" type="text" required class="form-control">
												</div>
