							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 style="text-transform: capitalize">Academic Qualifications</h2>
																			...
																			<div class="row gap-20">
																				<div class="col-sm-12 col-md-12">
																					...
																					<div class="form-group">
																						...
																						<select name="level" required class="selectpicker show-tick form-control" data-live-search="false" aria-placeholder="select">
																							...
																							<option <?php if ($level == "Certificate") {
																										print ' selected ';
																									} ?> value="Certificate">Certifications</option>
																							<option <?php if ($level == "Degree") {
																										print ' selected ';
																									} ?> value="Degree">Grad Degree</option>
									...
									<div id="QualifModal" class="modal fade login-box-wrapper" tabindex="-1" data-width="550" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
										...
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
											<h4 class="modal-title text-center" style="text-transform: capitalize">Add academic qualifications</h4>
										</div>
													...
													<div class="col-sm-12 col-md-12">
														...
														<div class="form-group">
															...
															<select name="level" required class="selectpicker show-tick form-control" data-live-search="false">
																...
																<option value="Degree">Grad Degree</option>
