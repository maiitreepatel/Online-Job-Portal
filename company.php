...
<head>
	...
	<title>NightingGale Jobs - <?php echo "$compname"; ?></title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php" style="text-transform: capitalize">Employer</a>
							</li>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="company-detail-wrapper">
								...
								<div class="section-title mb-40">
									...
									<h4 class="text-left" style="text-transform: capitalize">jobs offered at <?php echo "$compname"; ?></h4>
