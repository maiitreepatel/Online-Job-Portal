...
<head>
	...
	<title>NightinGale Jobs - Applicants <?php echo "$job_title"; ?></title>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title" style="text-transform: capitalize">Applicants for the job <?php echo "$job_title"; ?></h3>
						</div>
