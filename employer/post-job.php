						...
						<div class="col-sm-5 col-md-4">
							...
							<div class="company-detail-sidebar">
								...
								<h2 class="heading mb-15">
									...
									<p class="location"> <?php echo "$street"; ?> <?php echo "$city"; ?>, <?php echo "$country"; ?><br> <i class="fa fa-map-marker"></i> <?php echo "$zip"; ?> <span class="block"> <i class="fa fa-phone"></i> <?php echo "$myphone"; ?></span></p>
							...
							<div class="company-detail-wrapper">
								...
								<div class="company-detail-company-overview  mt-0 clearfix">
									...
									<div class="section-title-02">
										<h3 class="text-left" style="text-transform: capitalize">Post a Job</h3>
									</div>
