							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 style="text-transform: capitalize;">Profile</h2>
										...
										<div class="row gap-20">
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input name="year" placeholder="Enter year of Establishment" type="text" class="form-control" value="<?php echo "$esta"; ?>" required>
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													<label>Type</label>
													<input class="form-control" placeholder="Eg:Tech Company, Finance Company" name="type" required type="text" value="<?php echo "$mytitle"; ?>" required>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-md-4">
													<label>Website</label>
													<input type="text" placeholder="Enter your website" class="form-control" value="<?php echo "$myweb"; ?>" name="web">
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input name="city" placeholder="Enter your city" required type="text" class="form-control" value="<?php echo "$city"; ?>">
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													<label>Address</label>
													<input name="street" placeholder="Enter your street" required type="text" class="form-control" value="<?php echo "$street"; ?>" placeholder="Enter your street">
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input type="text" name="phone" placeholder="Enter your phone" required class="form-control" value="<?php echo "$myphone"; ?>">
												</div>
