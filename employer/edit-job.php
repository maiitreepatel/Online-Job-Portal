...
<head>
	...
	<title>Edit Job - <?php echo "$jobtitle"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><a href="company.php"><?php echo "$compname"; ?></a></li>
							...
							<div class="company-detail-wrapper">
								...
								<div class="company-detail-company-overview  mt-0 clearfix">
									...
									<div class="section-title-02">
										<h3 class="text-left" style="text-transform: capitalize"><?php echo "$jobtitle"; ?></h3>
									</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							...
							<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> NighinGale Jobs</p>
