		...
		<header id="header">
				...
				<div class="container">
					...
					<div class="nav-mini-wrapper">
						<ul class="nav-mini sign-in">
							<li><a href="login.php" style="text-transform: uppercase">Login</a></li>
							<li><a data-toggle="modal" href="#registerModal" style="text-transform: uppercase">register</a></li>
						</ul>
					</div>
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title text-center" style="text-transform: capitalize">Create your account for free</h4>
				</div>
								...
								<div class="col-sm-6 col-sm-offset-3">
									...
									<form name="frm" action="app/auth.php" method="POST" autocomplete="off">
										<div class="login-box-wrapper">
											...
											<div class="modal-header">
												<h4 class="modal-title text-center" style="text-transform: capitalize">Access your account</h4>
											</div>
									...
									<div id="forgotPasswordModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
										...
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
											<h4 class="modal-title text-center" style="text-transform: capitalize">Restore your password</h4>
										</div>
										...
										<div class="modal-body">
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-12">
													<p class="mb-20">Enter the email address associated to your account</p>
												</div>
												...
												<div class="col-sm-12 col-md-12">
													<div class="login-box-box-action">
														Return to <a data-dismiss="modal" href="login.php">Log-in</a>
														<p id="data"></p>
													</div>
										...
										<div class="modal-footer text-center">
											<button onclick="update(mymail.value)" type="submit" class="btn btn-primary">
												<a href='https://mail.google.com/mail/u/0/#inbox' style="color: inherit; text-decoration: none;">Restore</a>
											</button>
											<button type="button" data-dismiss="modal" class="btn btn-primary btn-inverse">Close</button>
										</div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">Employer</a></li>
