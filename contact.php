					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<h2 style="text-transform: capitalize">Contact us for help</h2>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
									<h5>Address</h5>
									<address> 123, MO Road <br />Bangalore</address>

								</li>
								<li>
									<h5>Email</h5><a href="">nightingale@gmail.com</a>
								</li>
								<li>
									<h5>Phone Number</h5><a href="">+91 123 456 7890</a>
								</li>
