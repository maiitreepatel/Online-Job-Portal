				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<!--<li>
								<a href="employees.php" style="text-transform: capitalize">Employee</a>
							</li>-->
					...
					<div class="nav-mini-wrapper">
						<ul class="nav-mini sign-in">
							...
							<li><a href="' . $myrole . '" style="text-transform: uppercase">Profile</a></li>';
							} else {
								print '
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>your bright future starts here </h1>
								...
								<div class="row gap-0">
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
										...
										try {
											...
											$stmt = $conn->prepare("SELECT * FROM tbl_categories ORDER BY id");
											$stmt->execute();
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
										...
										try {
											...
											$stmt = $conn->prepare("SELECT DISTINCT title FROM tbl_jobs ORDER BY title");
											$stmt->execute();
											$result = $stmt->fetchAll();
										...
										?>
												...
												<option style="color:black" value="<?php echo $row['title']; ?>"><?php echo $row['title']; ?></option>
										<?php
											}
											$stmt->execute();
										} catch (PDOException $e) {
			...
			<div class="row">
				...
				<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
					...
					<div class="section-title">
						...
						<br>
						<h3 style="text-transform: uppercase">Popular Companies</h3>
			...
			<div class="row">
				...
				<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
					...
					<div class="section-title">
						...
						<h3 style="text-transform: uppercase">LATEST JOBS</h3>
